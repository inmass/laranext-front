...
export const useCreateCondition = () => {
  ...
  return useMutation({
    mutationFn: async (data: CreateConditionFormData) => {
      const { data: response } = await axios.post<ConditionType>(ApiEndpoints.conditions, data);
      return response;
    },
    onSuccess: () => {
...
export const useUpdateCondition = () => {
  ...
  return useMutation({
    mutationFn: async (data: UpdateConditionFormData) => {
      const { data: response } = await axios.put<ConditionType>(`${ApiEndpoints.conditions}/${data.id}`, data);
      return response;
    },
    onSuccess: () => {
