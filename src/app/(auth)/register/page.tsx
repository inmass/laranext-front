    ...
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        <div>
          ...
          />
          <InputError
            messages={errors.name?.message ? [errors.name.message] : []}
            className="mt-2"
          />
        </div>
        ...
        <div className="mt-4">
          ...
          />
          <InputError
            messages={errors.email?.message ? [errors.email.message] : []}
            className="mt-2"
          />
        </div>
        ...
        <div className="mt-4">
          ...
          />
          <InputError
            messages={errors.phone?.message ? [errors.phone.message] : []}
            className="mt-2"
          />
        </div>
        ...
        <div className="mt-4">
          ...
          />
          <InputError
            messages={errors.password?.message ? [errors.password.message] : []}
            className="mt-2"
          />
        </div>
